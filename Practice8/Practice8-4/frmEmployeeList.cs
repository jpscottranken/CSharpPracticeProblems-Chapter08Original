...
/*
 *      4.	A company wants to keep track of its 
 *          employees' info such as first name, 
 *          last name, salary, and department. 
 *          
 *          Create a GUI C# program to create a 
 *          different list type for each field 
 *          representing an employee. 
 *          
 *          Allow a user to add new employees, 
 *          modify existing employees, delete 
 *          existing employees, and display all 
 *          employees.
 */
...
namespace Practice8_4
{
    public partial class frmEmployeeList : Form
    {
        ...
        //  This routine will be called when either
        //  the Add button or the Update button is
        //  clicked. It will verify that there is
        //  a value in each textbox. In addition,
        //  it will verify that the salary is
        //  numeric and within range (0 - 1000000).
